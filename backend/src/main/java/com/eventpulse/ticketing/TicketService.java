 ...
 */
@Service
public class TicketService implements TicketIssuer {

    public static final String REVEAL_PREFIX = "ep:ticket-reveal:";
    ...
    public TicketService(JdbcTemplate jdbc, OutboxWriter outbox, IdempotencyService idempotency,
    ...
    @Transactional
    public BookingDtos.RedeemResult redeem(UUID organiserUserId, String rawToken, String rawIdempotencyKey) {
        ...
        BookingDtos.RedeemResult result = new BookingDtos.RedeemResult("OK", ticket.id(), booking.id(),
