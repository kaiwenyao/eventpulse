package com.eventpulse.payment;
...
public class CommandDispatcher {
    ...
    private void complete(CommandRow command, Map<String, Object> result) {
        ...
        jdbc.update("""
                ...
                WHERE id = ?
                """, com.eventpulse.outbox.OutboxJson.write(result), command.id());
    ...
    private void recordAttempt(UUID commandId, int attemptNo, String outcome, Map<String, Object> detail) {
        jdbc.update("""
                ...
                VALUES (?, ?, ?, ?::jsonb)
                """, commandId, attemptNo, outcome, com.eventpulse.outbox.OutboxJson.write(detail));
    }
