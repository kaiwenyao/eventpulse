...
import com.eventpulse.booking.BookingDtos.BatchResult;
import com.eventpulse.booking.BookingDtos.BookingView;
import com.eventpulse.booking.BookingDtos.CreateBookingRequest;
import com.eventpulse.booking.BookingDtos.IntentRow;
import com.eventpulse.booking.BookingDtos.RefundView;
import com.eventpulse.booking.BookingDtos.TicketView;
import com.eventpulse.booking.BookingDtos.ViewRow;
...
public class BookingService {
    ...
    public BookingView createBooking(UUID userId, String rawIdempotencyKey, CreateBookingRequest request) {
        ...
        UUID bookingId = jdbc.queryForObject("""
                ...
                CanonicalJson.canonicalize(priceSnapshot, com.eventpulse.outbox.OutboxJson.mapper()),
                CanonicalJson.canonicalize(policySnapshot, com.eventpulse.outbox.OutboxJson.mapper()));
    ...
    private static Map<String, Object> parse(String json) {
        ...
        return com.eventpulse.outbox.OutboxJson.mapper().readValue(json, Map.class);
    }

    private Map<String, Object> defaultPolicySnapshot(String eventPolicy) {
        Map<String, Object> policy = eventPolicy == null ? Map.of()
                : com.eventpulse.outbox.OutboxJson.mapper().readValue(eventPolicy, Map.class);
