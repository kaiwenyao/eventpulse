...
import com.eventpulse.catalogue.CatalogueDtos.CreateEventRequest;
import com.eventpulse.catalogue.CatalogueDtos.FunnelRow;
import com.eventpulse.catalogue.CatalogueDtos.TierInput;
 ...
 */
@Service
public class OrganiserCatalogueService {

    private static final Logger log = LoggerFactory.getLogger(OrganiserCatalogueService.class);
    ...
    public OrganiserCatalogueService(JdbcTemplate jdbc, TransactionTemplate tx, OutboxWriter outbox, DbClock clock) {
        this.jdbc = jdbc;
        this.tx = tx;
        this.outbox = outbox;
        this.clock = clock;
    ...
    public void updateEvent(AuthUser user, UUID eventId, CatalogueDtos.UpdateEventRequest request) {
        requireOrganiser(user);
        UUID organiserId = ownedOrganiser(user);
