...
/**
 * Request-fingerprint idempotency. Concurrent claims wait for the first
 * transaction to commit, then either replay the stored response, fail with
 * 409 on a different fingerprint, or get a 202 while the first transaction is
 * still running.
 */
@Service
public class IdempotencyServiceImpl implements IdempotencyService {
    ...
    public IdempotencyServiceImpl(JdbcTemplate jdbc, AppProperties properties, DbClock clock,
